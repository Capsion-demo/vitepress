...
[![前端keep](https://pic3.zhimg.com/v2-19424e31d2f3e4ac0f041950cfb5d509_xs.jpg?source=172ae18b)](https://www.zhihu.com/people/chou-fei-hong)
...
**[系列一](https://link.zhihu.com/?target=https%3A//github.com/qiufeihong2018/vuepress-blog/blob/master/docs/technical-summary/electron-update/update.1.md)**从自动更新的方案深入地讲解了其中的原理，另外还讲解了两种打包方式。

**[系列二](https://link.zhihu.com/?target=https%3A//github.com/qiufeihong2018/vuepress-blog/blob/master/docs/technical-summary/electron-update/update.2.md)**列举了开发中出现的三个问题，分别是“`Can not find Squirrel`”、“安装目录中`packages`文件夹和`Update.exe`程序找不到”和“`Error: spawn UNKNOWN`”，从不同角度分析并且作了解答。
...
这个问题在 `Squirrel.Windows` 的 `issues`（`https://GitHub.com/Squirrel/Squirrel.Windows/issues/833`）中也有， 其中的回答绕不过一点：程序的错误，远程发布文件是空的或损坏影响我们的更新。
...
![img](https://pic4.zhimg.com/80/v2-5171ea0119ddf47cb592fd70be55b8d7_720w.jpg)
